...
export type T = {
  nav: { home: string; skills: string; projects: string; experience: string; education: string; blog: string; contact: string; hireMe: string };
  ...
  education: { label: string; title: string; present: string; current: string; grade: string };
...
const translations: Record<Lang, T> = {
  en: {
    nav: { home: 'Home', skills: 'Skills', projects: 'Projects', experience: 'Experience', education: 'Education', blog: 'Blog', contact: 'Contact', hireMe: 'Hire Me' },
    ...
    education: { label: 'Academic Background', title: 'Education', present: 'Present', current: 'Studying', grade: 'GPA' },
  ...
  ru: {
    nav: { home: 'Главная', skills: 'Навыки', projects: 'Проекты', experience: 'Опыт', education: 'Образование', blog: 'Блог', contact: 'Контакт', hireMe: 'Нанять меня' },
    ...
    education: { label: 'Академическое образование', title: 'Образование', present: 'По н.в.', current: 'Учусь', grade: 'Средний балл' },
  ...
  uz: {
    nav: { home: 'Bosh sahifa', skills: "Ko'nikmalar", projects: 'Loyihalar', experience: 'Tajriba', education: "Ta'lim", blog: 'Blog', contact: 'Aloqa', hireMe: 'Yollash' },
    ...
    education: { label: "Akademik ta'lim", title: "Ta'lim", present: 'Hozirgi kungacha', current: "O'qiyapman", grade: "O'rtacha baho" },
